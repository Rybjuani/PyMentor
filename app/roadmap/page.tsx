...
import { getAllModules, getLessonsByModuleSlug, getModuleProgress, getOverallLessonProgress, getProgressForRequest, isModuleUnlocked } from "@/lib/course";
...
export default function RoadmapPage() {
  ...
  return (
    <AppShell
      ...
      description="A clear beginner path with real lesson order, module progress, and completion states that carry across the product."
    >
      <Card className="rounded-[30px] bg-[linear-gradient(180deg,rgba(255,255,255,1),rgba(248,251,255,1))]">
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <div className="rounded-[24px] bg-brand-50 px-4 py-3 text-sm font-semibold text-brand-700">
            Progress follows you across pages
          </div>
        </div>
